...
#9152'"""
    ...
    @commands.command(aliases=['purge','delete'])#This is a purge commands,the aliases in paranthese means that you can call this command with the folllowing names.
